...
class PCD_Corr_Align(nn.Module):
    ...
    def forward(self, nbr_fea_l, ref_fea_l):
        ...
        L3_fea, L3_offset_absmean = self.L3_dcnpack(nbr_fea_l[2], L3_offset)
        ...
        L2_fea, L2_offset_absmean = self.L2_dcnpack(nbr_fea_l[1], L2_offset)
        ...
        L1_fea, L1_offset_absmean = self.L1_dcnpack(nbr_fea_l[0], L1_offset)
