...
# Network settings
parser.add_argument('--model', default='Boosted_BasicVSR', type=str, help='Import which network. [BasicVSR | Boosted_BasicVSR]')
...
parser.add_argument("--Threshold", type=float, default=0.2, help="Threshold of update")
